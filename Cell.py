...
class Cell():
    def __init__(self, container, eta_, numDivisions, omega_, colorValue):
    ...
    def tick(self):
        ...
        if len(proliferativePossibilities) > self.eta and self.numberDivisionsPerformed < self.omega:
