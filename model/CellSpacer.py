...
ax.set_title(f"Labeled Single Cancer Cell: mu = {-1}, omega = {defaultOmega}, tau = 1, t = 0")
ax.set_xlabel("x")
ax.set_ylabel("y")

def animate(t):
    displayMatrix.set_array(gridHistory[:, :, t])
    ax.set_title(f"Labeled Single Cancer Cell: mu = {-1}, omega = {defaultOmega}, tau = 1, t = {t}")
...
anim.save("/home/hytendf/Projects/IMOYear1/CellSpacer/OutputVideosAndGifs/labeledSingleCellCancerousTissueGrowth.mp4", writer = mpegWriter)

gifWriter = animation.PillowWriter(fps = 30)
anim.save("/home/hytendf/Projects/IMOYear1/CellSpacer/OutputVideosAndGifs/labeledSingleCellCancerousTissueGrowth.gif", writer = gifWriter)
